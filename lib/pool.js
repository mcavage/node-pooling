...
Pool.prototype._reap = function _reap() {
        ...
        function walk() {
                ...
                age = new Date().getTime() - obj.atime;
...
Pool.prototype._kill = function _kill(obj) {
        ...
        if (removePoolObject(this.objects, obj)) {
...
Pool.prototype._watch = function _watch(client) {
        ...
        this.events.forEach(function (e) {
                client.once(e, function watch() {
                        ...
                        // Deregister
                        self.events.forEach(function (e2) {
                                client.removeListener(e2, watch);
                        });
